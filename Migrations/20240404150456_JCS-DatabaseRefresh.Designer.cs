...
namespace BleebosBistro.Migrations
{
    ...
    [Migration("20240404150456_JCS-DatabaseRefresh")]
    partial class JCSDatabaseRefresh
    {
            ...
            modelBuilder.Entity("BleebosBistro.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1001,
                            Date = new DateTime(2024, 4, 4, 10, 4, 55, 795, DateTimeKind.Local).AddTicks(3435),
                        ...
                        {
                            Id = 1002,
                            Date = new DateTime(2024, 4, 3, 10, 4, 55, 795, DateTimeKind.Local).AddTicks(3472),
